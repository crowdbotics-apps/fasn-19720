...
admin.site.site_header = "FAsn"
admin.site.site_title = "FAsn Admin Portal"
admin.site.index_title = "FAsn Admin"

# swagger
api_info = openapi.Info(
    title="FAsn API",
    default_version="v1",
    description="API documentation for FAsn App",
)
